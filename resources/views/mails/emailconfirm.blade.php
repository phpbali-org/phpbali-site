        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse " data-color="blue" data-nav-image="/img/blurred-image-1.jpg">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="">CODE OF CONDUCTs</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="col-md-8">
                        <div class="card card-default">
                            <div class="card-header text-center">
                                <h4 class="card-title">Email Verified</h4>
                            </div>
            
                            <div class="card-body">
                                <span>Congratulations {{ $user->name }}, your email has been verified. Please Login.</span>
                            </div>
                        </div>
                    </div>
                </div>
