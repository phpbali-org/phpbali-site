                            ...
                            <div class="card card-profile card-plain">
                                <div class="card-avatar">
                                    <a href="{{ url('/member/'.$member->slug) }}">
                                        <img class="img img-raised" src="/img/avatar/{{$member->photos}}" data-toggle="tooltip" data-placement="top" title="{{ $member->name }}" data-container="body" data-animation="true" />
                                    </a>
                                </div>
                            </div>
                        </div>
