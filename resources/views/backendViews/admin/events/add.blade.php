        ...
        <div class="white-box">
            <form class="form-horizontal form-material" method="POST" enctype="multipart/form-data" action="{{ route('admin.event.store') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12">
                        <input type="text" name="start_datetime" id="startDatetime" class="form-control form-control-line no-block dateTime" placeholder="dd-mm-yyyy HH:mm" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12">End Datetime</label>
                    <div class="col-xs-12">
                        <input type="text" name="end_datetime" id="endDatetime" class="form-control form-control-line no-block dateTime" placeholder="DD-MM-YYYY HH:mm" />
                    </div>
                </div>
                <div class="form-group">
